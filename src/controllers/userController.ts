...
export async function user_create_post(req: Request, res: Response) {
...
export async function user_login_post(req: Request, res: Response) {
    let user_info = await user.get_user_by_username(req.body.username)
...
export function user_detail_get(req: Request, res: Response) {
    res.send("NOT IMPLEMENTED: User detail GET")
}

export async function user_detail_update(req: Request, res: Response) {
    res.send("NOT IMPLEMENTED: User detail UPDATE")
}

export async function user_detail_delete(req: Request, res: Response) {
